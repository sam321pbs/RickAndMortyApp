//
//  RMLocationDetailViewControllerExtension.swift
//  RickAndMortyApp 2.0
//
...
extension RMLocationDetailViewController: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        case .information(let location):
            ...
            cell.configure(uiModel: location[indexPath.row])
            return cell
        case .characters(let characters):
